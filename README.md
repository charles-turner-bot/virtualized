...
- `gbr4_simple_2024-01-17.nc`

The resulting logical array has dimensions `time,k,j,i` with shape
`(48, 47, 180, 600)`.

The store can be rebuilt directly from the public THREDDS HTTPServer
URLs with:

``` python
python py/ereefs_var.py temp remote/gbr4_temp_2024-01-16_2024-01-17.parq \
  https://thredds.nci.org.au/thredds/fileServer/fx3/gbr4_v2/gbr4_simple_2024-01-16.nc \
  https://thredds.nci.org.au/thredds/fileServer/fx3/gbr4_v2/gbr4_simple_2024-01-17.nc
```
